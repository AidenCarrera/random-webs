...
import styles from "./panic-screen.module.css";

export function PanicScreen() {
  return (
    <div
      className={`${styles.root} min-h-screen bg-black text-[#ff0033] flex items-center justify-center p-6 font-mono select-none`}
    >
