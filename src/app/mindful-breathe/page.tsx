...
export default function PastelDream() {
  ...
  return (
    <div className="min-h-screen w-full bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 flex flex-col items-center justify-center py-10 px-6 transition-all duration-1000 relative overflow-hidden select-none">
      <div className="flex-1 flex flex-col items-center justify-between w-full max-w-md py-6 gap-8 my-auto">
        
        {/* Header - spacing handles flow dynamically */}
        ...
        {/* Breathing Circle - sized dynamically to prevent overflow */}
        <div className="relative flex items-center justify-center w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 my-auto">
          <motion.div
            initial={{
              scale: 1,
              opacity: 0.45,
